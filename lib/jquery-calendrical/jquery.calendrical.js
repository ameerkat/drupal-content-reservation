(function($) {    
	...
	var manual_shift = -220;
	var manual_time_popup_shift = 0;
	var drupal_doesnt_love_me = -112;
    ...
    function findPos(obj){
		...
		if (obj.offsetParent) {
			...
			return [curleft,curtop + drupal_doesnt_love_me];
		}
	}
    ...
    $.fn.calendricalTime = function(options)
    {
        ...
        return this.each(function() {
            ...
            element.bind('focus click', function() {
                ...
                //var offset = element.offset();
				var offset = findPos(this);
				offset.left = offset[0] + manual_time_popup_shift + manual_shift;
				offset.top = offset[1];
                div = $('<div />')
